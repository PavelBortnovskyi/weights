...
public class PdfExportService implements Exporter {
        ...
        try (PDDocument document = new PDDocument();
            ...
            for (int i = 0; i < totalPages; i++) {
                ...
                try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                    ...
                    drawTable(document.getPage(i), contentStream, primaryBoldFont, dataList.subList(subListStartIndex, subListEndIndex));
                    contentStream.setFont(primaryFont, 12);
                    drawPageNumber(document.getPage(i), contentStream, i + 1);
    ...
    private void drawTable(PDPage page, PDPageContentStream contentStream, PDType0Font boldFont, List<TableData> dataList) throws IOException {
    ...
    private void drawColumnSum(PDPageContentStream contentStream, float y, float columnWidth, List<TableData> dataList) throws IOException {
        ...
        dataList.forEach(data -> {seedSum[0] += data.getSeeds();
